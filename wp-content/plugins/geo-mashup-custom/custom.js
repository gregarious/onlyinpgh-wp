...
images directory
  ...
  if (color_name == 'aqua') {
    icon = new GIcon();
    icon.image = 'http://www.onlyinpgh.com/test/wp-content/uploads/2011/08/mm_20_arts.png';
    icon.shadow = 'http://www.onlyinpgh.com/test/wp-content/uploads/2011/08/shadow.png';
