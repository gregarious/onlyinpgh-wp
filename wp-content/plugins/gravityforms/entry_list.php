    ...
    public static function leads_page($form_id){
        ...
        <script type="text/javascript">
            ...
            function BulkPrint(){
                ...
                var url = '<?php echo GFCommon::get_base_url() ?>/print-entry.php?fid=<?php echo $form['id'] ?>' + leadsQS + notesQS + pageBreakQS;
            ...
            jQuery(document).ready(function(){
                ...
                var list = jQuery("#gf_entry_list").wpList( { alt: '<?php _e('Entry List', 'gravityforms') ?>'} );
        ...
        <div class="wrap">
            ...
            <form id="lead_form" method="post">
                ...
                <ul class="subsubsub">
                    <li><a class="<?php echo empty($filter) ? "current" : "" ?>" href="?page=gf_entries&view=entries&id=<?php echo $form_id ?>"><?php _e("All", "gravityforms"); ?> <span class="count">(<span id="all_count"><?php echo $total_lead_count ?></span>)</span></a> | </li>
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" align="right" width="50">
                            <a title="<?php _e("Select Columns" , "gravityforms") ?>" href="<?php echo GFCommon::get_base_url() ?>/select_columns.php?id=<?php echo $form_id ?>&TB_iframe=true&height=365&width=600" class="thickbox entries_edit_icon"><?php _e("Edit", "gravityforms") ?></a>
                        </th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
                        ...
                        <th scope="col" style="width:15px;">
                            <a href="<?php echo GFCommon::get_base_url() ?>/select_columns.php?id=<?php echo $form_id ?>&TB_iframe=true&height=350&width=500" class="thickbox entries_edit_icon"><?php _e("Edit", "gravityforms") ?></a>
                        </th>
                    </tr>
                </tfoot>
                        ...
                        foreach($leads as $lead){
                            ...
                            <tr id="lead_row_<?php echo $lead["id"] ?>" class='author-self status-inherit <?php echo $lead["is_read"] ? "" : "lead_unread" ?> <?php echo $lead["is_starred"] ? "lead_starred" : "" ?> <?php echo in_array($filter, array("trash", "spam")) ? "lead_spam_trash" : "" ?>'  valign="top">
                                ...
                                if(!in_array($filter, array("spam", "trash"))){
                                    ?>
                                    <td >
                                        <img id="star_image_<?php echo $lead["id"]?>" src="<?php echo GFCommon::get_base_url() ?>/images/star<?php echo intval($lead["is_starred"]) ?>.png" onclick="ToggleStar(this, <?php echo $lead["id"] ?>);" />
                                    </td>
                                <?php
                                }
                                                ...
                                                switch($filter){
                                                    ...
                                                    default:
                                                        ...
                                                        <span class="edit">
                                                            ...
                                                            <?php echo GFCommon::current_user_can_any("gravityforms_delete_entries") || GFCommon::has_akismet() ? "|" : "" ?>
                                                        </span>
                                                        <?php
                                                        if(GFCommon::has_akismet()){
                                                            ?>
