...
class Facebook
{
   ...
   * 
   * JUSTIN: I HAD TO MODIFY THIS FUNCTION! See below...
   *
  ...
  public function getSession() {
    if (!$this->sessionLoaded) {
      ...
      // JUSTIN: An issue introduced by Wordpress screws up the following section, so I had to modify it to work!
      // In wp-includes/load.php's wp_magic_quotes(), WP explicitly escapes the $_COOKIE variable ($_COOKIE = add_magic_quotes( $_COOKIE );)
      // However, as magic_quotes_gpc is still technically off, the following will not strip the slashes, and thus the session cookie won't be parsed correctly.
      // To fix this, I changed the condition in the ternary operator below.
