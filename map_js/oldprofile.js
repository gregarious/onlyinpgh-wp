...
function createLocationMarker(latlng, fans, organization, category, pic, address, fans) {
	...
	if (type == 'FOOD/GROCERY' && fans < 2000){
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/food.png',
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/theaterfilm.png',
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 1;
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/shopping.png',
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 1;
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/genfun.png',
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 1;
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/museum.png',
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 1;
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/spots.png',
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 1;
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/music.png',
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 1;
		...
		var icontype = new google.maps.MarkerImage('http://onlyinpgh.com/place_dots/attractions.png',				
					new google.maps.Size(12,12),
					new google.maps.Point(0,0),
					new google.maps.Point(0,0));
		var locationvalue = 2;
